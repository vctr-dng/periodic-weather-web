...
class User {
    ...
    static async createUser() {
        ...
        let correctCoordinates = await User.getCoordinatesFromCity(randomUser.location.city)
        
        console.log(correctCoordinates)

        let user = new User(randomUser.name.first, randomUser.name.last, correctCoordinates)
